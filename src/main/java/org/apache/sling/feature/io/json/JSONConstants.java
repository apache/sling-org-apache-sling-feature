...
public abstract class JSONConstants {
    ...
    static final List<String> FEATURE_KNOWN_PROPERTIES = Arrays.asList(
            FEATURE_ID,
    ...
    static final List<String> ARTIFACT_KNOWN_PROPERTIES =
            Arrays.asList(ARTIFACT_ID, Configuration.PROP_ARTIFACT_ID, FEATURE_CONFIGURATIONS);
